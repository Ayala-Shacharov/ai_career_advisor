...
const DB_FILE = fileURLToPath(new URL('../../data/user-inputs.json', import.meta.url));
const isValidText = (value) => typeof value === 'string' && value.trim().length > 0;
const isValidAnswers = (value) => {
...
export const matchProfession = async (req, res) => {
